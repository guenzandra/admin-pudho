  ...
  <div id="sidebar" class="h-screen bg-white shadow-lg fixed left-0 top-0 w-64 flex flex-col border-r border-gray-200 z-30 transition-all duration-300 -translate-x-full lg:translate-x-0 lg:sidebar-expanded">
    ...
    <div class="flex-1 overflow-y-auto py-4 scrollbar-thin">
      ...
      <div class="px-4 space-y-1">
        <!-- Dashboard -->
        <a href="{{ route('editor.editorDashboard') }}" class="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-700 hover:bg-red-50 hover:text-red-700 transition duration-200 group">
        ...
        <div>
          ...
          <div id="cmsDropdown" class="hidden pl-11 space-y-1 mt-1">
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">All Post</a>
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Add Post</a>
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Categories</a>
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Media Library</a>
          </div>
        </div>
        ...
        <div class="pt-4 mt-2 border-t border-gray-100">
          ...
          <div>
            ...
            <div id="messagesDropdown" class="hidden pl-11 space-y-1 mt-1">
              <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Inbox</a>
              <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Sent</a>
              <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Archived</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div id="faqsDropdown" class="hidden pl-11 space-y-1 mt-1">
              <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Pending Questions</a>
              <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Answered</a>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div id="settingsDropdown" class="hidden pl-11 space-y-1 mt-1">
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">General</a>
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Security</a>
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Notifications</a>
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Audit Logs</a>
            <a href="{{ route('#') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg sidebar-submenu">Help</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="flex items-center space-x-4 lg:space-x-6">
          ...
          <div class="relative">
            ...
            <div id="profileDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-1 border border-gray-200">
              ...
              <a href="{{ route('#') }}" class="flex items-center space-x-2 px-4 py-2 text-sm text-gray-700 hover:bg-red-50 hover:text-red-700 group">
              ...
              <a href="{{ route('#') }}" class="flex items-center space-x-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 group">
