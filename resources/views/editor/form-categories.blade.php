...
<body>
    ...
    <div class="page">
        <div class="page-header">
            ...
            <p>Manage form categories and organize downloadable files for the public</p>
        </div>
        ...
        <div class="card">
            ...
            <div class="stats-bar">
                ...
                <div class="stat-item">
                    <div class="s-val" id="statFiles">—</div>
                    <div class="s-lbl">Total Files</div>
                </div>
                <div class="stat-item">
                    <div class="s-val" id="statAvg">—</div>
                    <div class="s-lbl">Avg. Files / Category</div>
                </div>
            </div>
            ...
            <div class="row-hint">
                ...
                Click any row to view, edit, or delete
            </div>
        ...
        <div class="modal">
            <div class="modal-header">
                <div>
                    ...
                    <p id="catModalSub">Give the category a name and color label</p>
                </div>
            ...
            <div class="modal-body">
                <div class="field">
                    ...
                    <input type="text" id="fCatName" placeholder="e.g. Application Forms, Permits…">
                </div>
                <div class="field">
            ...
            <div class="modal-footer">
                ...
                <div class="footer-right">
                    ...
                    <button class="btn btn-gold" onclick="submitForm()">Save Category</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal">
            <div class="modal-header">
                <div>
                    ...
                    <p>Overview and files in this category</p>
                </div>
            ...
            <div class="modal-body">
                <div class="view-cat-head">
                    <div class="view-cat-icon" id="vm-icon">A</div>
                    <div>
                        <div style="font-size:17px;font-weight:700;color:var(--ink)" id="vm-name">—</div>
                        <div style="font-size:12px;color:var(--muted);margin-top:.15rem" id="vm-count">—</div>
                    </div>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="val" id="vm-file-count">—</span>
                </div>
                <div class="section-label">Files in this Category</div>
                <div class="files-list" id="vm-files"></div>
            </div>
            <div class="modal-footer">
    ...
    <script>
        ...
        let categories = [{
                ...
                files: [{
                    ...
                    {
                        name: 'Application for Barangay Clearance',
                        type: 'docx'
                    },
                    {
                        name: 'Application for Mayor\'s Permit',
                        type: 'pdf'
                    },
                    {
                        name: 'Application for Health Certificate',
                        type: 'pdf'
                    },
                    {
                        name: 'Application for Environmental Clearance',
                        type: 'pdf'
                    },
                    {
                        name: 'Application for Zoning Certificate',
                        type: 'docx'
                    },
                    {
                        name: 'Application for Occupancy Permit',
                        type: 'pdf'
                    },
                    {
                        name: 'Application for Sanitary Permit',
                        type: 'pdf'
                    },
                    {
                        name: 'Application for Fire Safety Inspection',
                        type: 'pdf'
                    },
                    {
                        name: 'Application for FSIC',
                        type: 'docx'
                    },
                    {
                        name: 'Application for Community Tax Certificate',
                        type: 'pdf'
                    },
                ]
            },
            {
                ...
                color: 'purple',
                files: [{
                        name: 'Documentary Requirements Checklist',
                        type: 'pdf'
                    },
                    {
                        name: 'ID Requirements List',
                        type: 'pdf'
                    },
                    {
                        name: 'Income Requirements Form',
                        type: 'docx'
                    },
                    {
                    ...
                    {
                        name: 'Medical Requirements Form',
                        type: 'pdf'
                    },
                    {
                    ...
                    {
                        name: 'School Enrollment Requirements',
                        type: 'pdf'
                    },
                    {
                        name: 'Social Services Requirements',
                        type: 'docx'
                    },
                ]
            },
            {
                ...
                color: 'green',
                files: [{
                        name: 'Certificate of Indigency Template',
                        type: 'docx'
                    },
                    {
                    ...
                    {
                        name: 'Certificate of Employment Template',
                        type: 'docx'
                    },
                    {
                    ...
                    {
                        name: 'Certificate of Live Birth Copy Request',
                        type: 'pdf'
                    },
                ]
            },
    ...
    <label class="color-opt" title="${c.label}">
      ...
      <div class="color-swatch" style="background:${c.bg};border-color:${c.dot}40">
        ...
        function filtered() {
            ...
            const cf = document.getElementById('catColorFilter').value;
    ...
    <tr>
      <td><div style="display:flex;align-items:center;gap:.6rem"><div class="skel skel-dot"></div><div class="skel skel-text" style="width:110px"></div></div></td>
      ...
      <td></td>
        ...
        function _render() {
            ...
            const totalFiles = categories.reduce((a, c) => a + c.files.length, 0);
            document.getElementById('catSubline').textContent = `${categories.length} categor${categories.length!==1?'ies':'y'} · ${totalFiles} total files`;
      ...
      <tr><td colspan="4">
        <div class="empty-state">
          <div class="empty-icon"><svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg></div>
          <h3>No categories found</h3><p>Try adjusting your search or filter.</p>
        </div>
      </td></tr>`;
                return;
            }
      ...
      <tr onclick="openViewModal(${c.id})">
        ...
        function openAddModal() {
            ...
            document.getElementById('catModalSub').textContent = 'Give the category a name and color label';
        ...
        function submitForm() {
            ...
            const color = document.querySelector('input[name="catColor"]:checked')?.value || 'blue';
            if (editingId) {
        ...
        function openViewModal(id) {
            ...
            document.getElementById('vm-count').textContent = `${c.files.length} file${c.files.length!==1?'s':''}`;
            document.getElementById('vm-name2').textContent = c.name;
            document.getElementById('vm-color-pill').innerHTML = colorPill(c.color);
            document.getElementById('vm-file-count').textContent = c.files.length;

            const fl = document.getElementById('vm-files');
            if (c.files.length) {
                fl.innerHTML = c.files.map(f => {
                    const ft = fileTypeStyle(f.type);
                    return `
        <div class="file-item">
          <div class="file-icon" style="background:${ft.bg}">
            <svg width="14" height="14" fill="none" stroke="${ft.icon}" stroke-width="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
          </div>
          <span class="file-name" title="${f.name}">${f.name}</span>
          <span class="file-type" style="background:${ft.bg};color:${ft.text}">${f.type.toUpperCase()}</span>
        </div>`;
                }).join('');
            } else {
                fl.innerHTML = `<div style="font-size:12px;color:var(--muted);font-style:italic;padding:.5rem 0">No files in this category yet.</div>`;
            }
        ...
        function confirmDelete(id) {
            ...
            document.getElementById('confirmMsg').textContent = c && c.files.length ?
                `This will also remove ${c.files.length} file${c.files.length!==1?'s':''} inside it. This cannot be undone.` :
        ...
        document.getElementById('catColorFilter').addEventListener('change', () => render(true));
