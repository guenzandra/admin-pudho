      ...
      <div class="px-4 space-y-1">
        ...
        <div>
          ...
          <div id="cmsDropdown" class="hidden pl-11 space-y-1 mt-1">
            <a href="{{ route('articles') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Articles</a>
            <a href="{{ route('announcement') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Announcements</a>
            <a href="{{ route('news') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">News</a>
            <a href="{{ route('media') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Media Library</a>
          </div>
        </div>
        ...
        <div>
          ...
          <div id="squattingDropdown" class="hidden pl-11 space-y-1 mt-1">
            <a href="{{ route('reports') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Reports</a>
            <a href="{{ route('investigation') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Investigation</a>
            <a href="{{ route('mapview') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Map View</a>
          </div>
        </div>
        ...
        <div class="pt-4 mt-2 border-t border-gray-100">
          ...
          <div>
            ...
            <div id="messagesDropdown" class="hidden pl-11 space-y-1 mt-1">
              <a href="{{ route('inbox') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Inbox</a>
              <a href="{{ route('sent') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Sent</a>
              <a href="{{ route('archived') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Archived</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div id="faqsDropdown" class="hidden pl-11 space-y-1 mt-1">
              <a href="{{ route('pending') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Pending Questions</a>
              <a href="{{ route('answered') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Answered</a>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div id="settingsDropdown" class="hidden pl-11 space-y-1 mt-1">
            <a href="{{ route('general') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">General</a>
            <a href="{{ route('help') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Security</a>
            <a href="{{ route('notifications') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Notifications</a>
            <a href="{{ route('logs') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Audit Logs</a>
            <a href="{{ route('security') }}" class="block px-3 py-2 text-sm text-gray-600 hover:bg-red-50 hover:text-red-700 rounded-lg">Help</a>
          </div>
        </div>
      </div>
    </div>
